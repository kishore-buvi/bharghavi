            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final productData = product.data() as Map<String, dynamic>;
                  final basicInfo = productData['basicInfo'] ?? {};
                  final pricing = productData['pricing'] ?? {};
                  final media = productData['media'] ?? {};
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8),
                                child: media['featuredImage'] != null
                                    ? CachedNetworkImage(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      basicInfo['name'] ?? 'Unknown Product',
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: status['isActive'] == true ? Colors.green : Colors.red,
                                    ...
                                    onPressed: () {
                                      showDialog(
                                        ...
                                        builder: (context) => AlertDialog(
                                          ...
                                          content: Text('Are you sure you want to delete "${basicInfo['name']}"?'),
                                          actions: [
                                            TextButton(
                                              onPressed: () {
                                                Navigator.of(context).pop();
